...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Tujifunze blog", url="https://t.me/tujifunzeblog"),
                InlineKeyboardButton("zilizotafiliwa ⭕️", url="https://t.me/+07Ds2jlIe1o0OWY0")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ msaada', url='https://t.me/kibandainfo'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/tujifunzeblog')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Kiswahili 🎬', url=f'https://t.me/+07Ds2jlIe1o0OWY0')
            ]
            ]
        ...
        buttons = [[
            InlineKeyboardButton('➕ Add mimi kwenye kikundi chako ➕', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('⭕️ Msaada', callback_data='help'),
            InlineKeyboardButton('kuhusu ⭕️', callback_data='about')
            ],[
            InlineKeyboardButton('🕵️ Tafuta movie 🕵️', switch_inline_query_current_chat='')
            ],[
            InlineKeyboardButton('⭕️ Mapya', url='https://t.me/kibandainfo'),
            InlineKeyboardButton('Tujifunze blog ⭕️', url='https://t.me/tujifunzeblog')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('T-blog 👨🏽‍💻', url='https://t.me/tujifunzeblog')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/kibandainfo'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie Swahili", url="https://t.me/+07Ds2jlIe1o0OWY0"),
        InlineKeyboardButton("T BLOG ⭕️", url="https://t.me/tujifunzeblog")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ jiunge Channel yetu ⭕️",url="https://t.me/kibandainfo")
    ])
